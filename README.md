...
## Warning 
These API are no more working. The databases for these have been deleted. Some New apis are working which fetch the data. Documentation will be updated soon. Contact for help :- 6283747626
